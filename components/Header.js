	...
	<div className= {"container flex justify-between h-16 mx-auto"}>
        ...
        {/* TODO - lookup noopener noreferrer?? */}
			...
			<li className="flex">
				...
				<a rel="noopener noreferrer" href="/login" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400">
                    Log In
                </a>
			</li>
